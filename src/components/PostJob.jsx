...
const PostJob = () => {
  ...
  return (
    <Container className="my-5" style={{ paddingTop: "5rem" }}>
      ...
      <h1 className="font-weight-bold text-dark" style={{ fontSize: "2.5rem" }}>
        Job Post
      </h1>
      ...
      <Form
        ...
        className="shadow p-4 mb-5 bg-light rounded"
      >
      ...
      {/* Job Cards Section */}
      <h3 className="my-4 text-center font-weight-bold text-primary">Available Job Posts</h3>
